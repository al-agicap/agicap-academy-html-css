...
@Component({
    ...
    imports: [MatExpansionModule, MatTabsModule, ExampleDirectivesComponent, FlipperComponent, HtmlCssBestPraticesComponent, CssEncapsulationComponent, FlexGridComponent]
})
